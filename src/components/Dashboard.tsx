        ...
        <div className="px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span>{mockCurrentSpace.name}</span>
            </div>
            <div className="flex items-center gap-2 text-sm">
              <span className="text-muted-foreground">Curator:</span>
              <span>{mockCurrentSpace.currentCurator}</span>
            </div>
          </div>
      ...
      <div className="flex-1 flex">
        ...
        <aside className="w-64 border-r border-border bg-card/30 p-6">
          ...
          <div className="mt-8 pt-6 border-t border-border">
            <div className="text-xs text-muted-foreground space-y-1">
              <p>Week {mockCurrentSpace.weekNumber}</p>
        ...
        <main className="flex-1 overflow-auto">
          <div className="max-w-3xl mx-auto p-8">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-muted-foreground">
                  Week {mockCurrentSpace.weekNumber} · Nov 3–9, 2025
                </span>
              </div>
              <h1 className="mb-2">This Week's Prompts</h1>
              <p className="text-muted-foreground">
                Curated by {mockCurrentSpace.currentCurator}
            ...
            {/* Curator Note */}
            {mockCurrentSpace.currentCurator === "Emma Chen" && (
